...
/** REST controller for managing {@link com.localuz.domain.Address}. */
@RestController
@RequestMapping("/api")
@Transactional
public class AddressResource {
    ...
    // new address, or with status {@code 400 (Bad Request)} if the address has already an ID.
    //     * @throws URISyntaxException if the Location URI syntax is incorrect.
    //     */
    //    @PostMapping("/addresses")
    //    public ResponseEntity<Address> createAddress(@Valid @RequestBody Address address) throws
    // URISyntaxException {
    ...
    //
    //    /**
    //     * {@code PATCH  /addresses/:id} : Partial updates given fields of an existing address,
    ...
    //     * @throws URISyntaxException if the Location URI syntax is incorrect.
    //     */
    //    @PatchMapping(value = "/addresses/{id}", consumes = { "application/json",
    ...
    //     *
    //     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of addresses
    // in body.
    //     */
    ...
    // address, or with status {@code 404 (Not Found)}.
    //     */
